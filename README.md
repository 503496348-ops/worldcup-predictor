...
<p align="left">
<a href="https://github.com/503496348-ops/worldcup-predictor/stargazers"><img alt="GitHub stars" src="https://img.shields.io/github/stars/503496348-ops/worldcup-predictor?style=social"></a>
<a href="https://github.com/503496348-ops/worldcup-predictor/issues"><img alt="GitHub issues" src="https://img.shields.io/github/issues/503496348-ops/worldcup-predictor"></a>
<img alt="License" src="https://img.shields.io/github/license/503496348-ops/worldcup-predictor">
<a href="https://github.com/503496348-ops/worldcup-predictor/actions/workflows/ci.yml"><img alt="CI" src="https://github.com/503496348-ops/worldcup-predictor/actions/workflows/ci.yml/badge.svg"></a>
<img alt="Domain" src="https://img.shields.io/badge/domain-%E4%BD%93%E8%82%B2%E5%88%86%E6%9E%90-blue">
</p>

## Highlights

- **Product**: WorldCup Predictor / 绿茵智脑
- **Domain**: 体育分析
...
> 2026 FIFA World Cup match predictor — Elo + Dixon-Coles bivariate Poisson + Monte Carlo simulation. 48-team tournament model with live results conditioning.
...
3. 对照本产品定位验证输出：**绿茵智脑（WorldCup Predictor）** 属于 **体育分析** 产品，目标是把输入材料转化为可检查、可复用的结果。
